...
RAW_COOKIE_STRING = "_t=sVox1rBK%2FgNmM7145hEC5wB1gk%2F%2BQBU1J%2FnFAbISCAzb6wz9XFP6wbbggZhVW98RILkbK6zMhlgn14lbCTGhHusPluZ%2BBi%2B%2BH0qCJ0EcdWQJrz74oSGRDFlY28SJzi8lSf6Rj7ehVlQPqzoQ4k7sRKBNik1PsTNOjWiIQH9KeT%2F63aEJ1%2F2dt3o9ZRl5ZCGX6Y8eMNinVJJFw9oYwt6Kg9TjcRn13GciDCPA0VqQQgeedBBFtPUoQZKKNO3W9yAUhvwSXTLTQUwjk%2FOynlynkKtQTpWQI4o6axQbjI9oLJ%2FJ1n0B3ZmfVIz300CkG2Rk--%2B%2FD10rq%2BXTwipJS7--xDLGHDoPQZj7WfAXaem8yg%3D%3D; _ga_08NPRH5L4M=GS1.1.1734688674.1.0.1734688876.60.0.0; _ga=GA1.1.1055420972.1734688675; _bypass_cache=true;" # Replace with your actual cookie string
...
def get_full_topic_json(base_url, topic_id, cookies):
    ...
    for post in topic_data["post_stream"]["posts"]:
        ...
        if post_number:
            post["url"] = f"{base_url.rstrip('/')}/t/{topic_id}/{post_number}"
